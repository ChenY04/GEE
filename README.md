...
<br>(1) This tool is an improvement on the tool published by Zhao et al. We thank them for their work; please cite "Zhao, T., Zhang, X., & Liu, L. (2026). An interactive toolkit based on Google Earth Engine for visual interpretation and analysis of land cover and land cover changes. Big Earth Data, 1-25."
<br>(2) Recommended usage: AIExTool -> SSD_VCT (import auxiliary information such as FVC, greening period, NDVI, NDBI, NDWI, soil type, elevation, etc.); load the inspection tool).
<br>(3) AIExTool: https://code.earthengine.google.com/5aa7db1f87361ae7dbb70bdcef7be6e4?noload=true; SSD_VCT: https://code.earthengine.google.com/06e5b73a3985a7c70fa5fede558259d2?noload=true.
<br>(4) "AuxiliaryExtract", "vi_sg", and "vi_spectrum" are external functions.
